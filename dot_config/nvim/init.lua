...
-- Markdown preview
vim.keymap.set('n', '<leader>md', ':MarkdownPreview<CR>', { desc = '[M]arkdown [P]review Start' })
vim.keymap.set('n', '<leader>mds', ':MarkdownPreviewStop<CR>', { desc = '[M]arkdown [P]review [S]top' })
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('<C-n>', vim.lsp.buf.hover, 'Hover Documentation')
